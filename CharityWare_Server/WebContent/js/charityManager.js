...
/*--------------------------View all form data--------------------*/
function viewCurrentFormData(id)
{
	$.get("RESTCharity/formService/form/"+urlHibernate+"/id/"+id, function(data) {
...
/*------------------------------View form Structure----------------------------*/
function writeFormStructure(id) {
	...
	$.get('RESTCharity/formService/form/' + urlHibernate + '/id/' + id, function(data) {
		...
		if(colArray.length > 0)
		{
			...
			for(var i = 0 ; i < colArray.length; i++)
			{
				...
				typeRow.appendChild(document.createTextNode(colArray[i].field_type.field_Description));
